...
contract BLSExample {
  ...
  17039283792713629953217756598150981109636679343767085841835508695942368202923],
   [
    ...
    function hashToG2T(uint256 h) public returns (uint256,uint256,uint256,uint256) {
        // uint256 h = 12312312345;  //uint256(keccak256(message));
        G2Point memory p2 = P2();
        // uint256 x1;
        // uint256 x2;
        ...
        // uint256 y2;
        // (x1,x2,y1,y2) =
        return BN256G2.ECTwistMul(h, p2.X[1], p2.X[0], p2.Y[1], p2.Y[0]);
        // G2Point memory g2 =;
